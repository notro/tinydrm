...
/**
 * tinydrm_regmap_debugfs_init - Initialize regmap debugfs entry
 * @reg: Regmap
 * @parent: Parent &dentry for the file
 *
 * This function adds a 'registers' debugfs file that can be used to access
